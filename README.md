# WAmp Community Edition

Continuation of Winamp

If there is any proprietary code in this repository, please remove it and pull request, then we will squash the tree to remove the code.
WAmp maintainers are not responsible for any proprietary code in this repository, the people who are though are the original developers of Winamp who posted it on github.

## About

WAmp is a multimedia player launched in 1997, iconic for its flexibility and wide compatibility with audio formats. Originally developed by Nullsoft, it gained massive popularity with still millions of users. Its development slowed down, but now, its source code was opened to the community, allowing developers to improve and modernize the player to meet current user needs.

It really whips the llama's ass.

## Usage

Building of the WAmp desktop client is currently based around Visual Studio 2019 (VS2019) and Intel IPP libs (You need to use exactly v6.1.1.035).
There are different options of how to build WAmp:
